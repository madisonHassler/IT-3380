...
db.zips.find({"pop":{$lt:2000}, "state":"OH"}, {"city" : 1, "pop" : 1, "_id": 1});
...
db.zips.find({"pop":{$gt:50000}}, {"city" : 1, "pop" : 1, "_id": 1});
...
db.zips.find({"pop":{$eq:10}}, {"id":1, "city":1, "state":1})
...
db.stocks.find({"EBITDA":{$gte:2500000000}}, {"Sector":1, "Name":1, "EBITDA":1});

//  List the company name, symbol and sector for all companies with a 52 Week High greater than or equal to 150.
db.stocks.find({"52 Week High":{$gte:150}}, {"Sector":1, "Name":1, "Symbol":1});
...
db.stocks.find({"Sector":"Real Estate", "Price":{$lt:50}}, {"Price":1, "Name":1, "Symbol":1});

//  List the company name, symbol and dividend yield for companies in the Utilities or Industrials sectors.
db.stocks.find({$or:[{"Sector":"Utilities"}, {"Sector":"Industrials"}]}, {"Dividend Yield":1, "Name":1, "Symbol":1});
...
db.stocks.find({$or:[{"Dividend Yield":{$gt:3}},{"Earnings/Share":{$lt:1}}]}, {"Market Cap":1, "Name":1, "Symbol":1});
