...
FROM agents a, customer c, orders o
WHERE a.AGENT_CODE = o.AGENT_CODE AND c.CUST_CODE = o.CUST_CODE AND c.CUST_CITY = "New York";
...
FROM agents a, customer c, orders o
WHERE a.AGENT_CODE = o.AGENT_CODE AND c.CUST_CODE = o.CUST_CODE AND c.OUTSTANDING_AMT >= 6000;
...
SELECT a.AGENT_NAME, a.WORKING_AREA, c.CUST_CITY, c.WORKING_AREA
FROM agents a, customer c
WHERE c.AGENT_CODE = a.AGENT_CODE AND c.WORKING_AREA = a.WORKING_AREA;
